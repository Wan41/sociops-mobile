            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text('Upload Sampul', style: FontFamily().mediumteks),
                ),
                Align(
                ...
                Padding(
                  padding: const EdgeInsets.all(16),
                  child: Text('Nama Komunitas', style: FontFamily().mediumteks),
                ),
                Align(
                    alignment: Alignment.center,
                ...
                Padding(
                  padding: const EdgeInsets.all(16),
                  child:
                      Text('Tentang Komunitas', style: FontFamily().mediumteks),
                ),
                Align(
                  alignment: Alignment.center,
                  child: Container(
