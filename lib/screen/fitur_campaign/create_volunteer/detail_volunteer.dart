...
class DetailVolunteerScreen extends StatefulWidget {
  const DetailVolunteerScreen({Key? key}) : super(key: key);

  @override
  State<DetailVolunteerScreen> createState() => _DetailVolunteerScreenState();
}

class _DetailVolunteerScreenState extends State<DetailVolunteerScreen> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 26, bottom: 20),
                  child: Text('Vidio Promosi', style: FontFamily().mediumteks),
                ),
                Center(
                  child: Column(
                    children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 26, bottom: 20),
                  child: Text('Tindakan yang harus diambil',
                      style: FontFamily().mediumteks),
                ),
                ListileWidget(
                  title: "Aksi 1",
